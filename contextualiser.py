...
INSTRUCTIONS = (
    "You are an expert at adding context to user queries, based on their answers to some clarifying questions.\n" 
...
contextualising_agent = Agent(
    name="ContextualisingAgent",
